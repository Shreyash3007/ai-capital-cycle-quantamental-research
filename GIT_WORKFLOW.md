...
4. Update [PROGRESS.md](PROGRESS.md), affected [knowledge nodes](Knowledge/INDEX.md), and [KNOWLEDGE_GRAPH.md](KNOWLEDGE_GRAPH.md). Refresh [LEARNING_MANUAL.md](LEARNING_MANUAL.md) and its PNG diagram when the learner's next step changes.
